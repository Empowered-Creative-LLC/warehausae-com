...
intro_prose: |-
  No one knows your business better than you. It’s for that reason we believe collaboration is the key to mutual success.

  Together, we’ve created a roadmap that refines the project vision upfront, resulting in fresh ideas that articulate a clear design intention from the very start.

  Whether your project is a Design Build in York, a test fit in Lancaster, or a renovation in Harrisburg, you’ll find a trustworthy partner in the team at Warehaus.
capabilities:
  - Architecture
  - Interior Design
  - Master Planning
...
photo_gallery:
  ...
  - image_url: /assets/imported/2023/04/York-Academy-Regional-Charter-Upper-School_Professional-052419_00084.jpg
approach_blocks:
  ...
  - title: Community Feedback
    body: >-
      By gathering feedback from community members early in the ideation process, we incorporate the wants and needs of residents, business owners, and invested community members into our proposed
      solution.
  - title: Design Charettes
    body: Design charettes fuel the ideation process by bringing together all invested parties and exploring together the question of 'What if?'
  - title: Concept Sketches
    body: >-
      Through the incorporation of first-hand experience, community feedback, research, and client needs, all the details come together in concept sketches – they are the first step in bringing the
      vision to life!
team_leaders:
...
recent_projects:
  ...
  - title: "I-81 Safety Rest Areas"
    url: /project/i-81-safety-rest-areas/
    categories:
      - Architecture
      - Civil
    image_url: /assets/imported/2023/07/I-81-Rest-Area-700x700.webp
...
hero_image_url: /assets/images/home/iconbar/Architecture.png
